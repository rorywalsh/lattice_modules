...
SampParam(std::size_t np) : params({ "Base Note ", "Fine Tune ", "Freq Shift ",
      "Spec Warp ", "Gain", "Start Pos ", "Loop Start ", "Loop End ",
      "Timescale ", "Keep Formants ","Load Sample ", "Clear Sample "}),
    pnames(np) {
    std::size_t n = 0;
    char mem[4];
